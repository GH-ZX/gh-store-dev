...
import { loadMaxStoreCatalogue } from "@server/legacy/lib/services/maxstore-import.service";
...
import { importMaxStoreAction } from "@/lib/admin-actions";
...
const messages = getMessages(locale, "admin"); const page = messages.providers.maxstoreImport; const shared = messages.import; const providerErrors = messages.providers.g2bulk.errors;
  return (
