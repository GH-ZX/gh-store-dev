...
import type { WalletSummary, WalletTransaction } from "@server/lib/services/wallet.service";
...
export function WalletSummaryPanel({
  ...
  return (
    <div className="sf-commerce-panel sf-wallet-balance">
...
export function TransactionList({
  ...
  return (
    <ul className="sf-transaction-list">
