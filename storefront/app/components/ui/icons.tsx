...
/** Google's multicolor brand mark, used beside the labeled OAuth action. */
export function GoogleIcon(props: IconProps) {
  return (
    ...
    >
      ...
      <path fill="#34A853" d="M12 23c2.97 0 5.46-.99 7.28-2.66l-3.57-2.77c-.99.66-2.25 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.15v2.84C3.96 20.53 7.7 23 12 23z" />
      ...
      <path fill="#EA4335" d="M12 5.27c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.96 3.47 2.15 7.06l3.69 2.84C6.71 7.2 9.14 5.27 12 5.27z" />
    </svg>
  );
}
