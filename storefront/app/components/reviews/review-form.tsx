...
} from "@/components/commerce/review-state";
import type { MyReview } from "@server/lib/services/reviews.service";
...
export function ReviewForm({
  ...
  const [state, _formAction, pending, formActionSubmit] = useCommerceAction<ReviewActionState>('submitReviewAction',
    INITIAL_REVIEW_STATE,
  );
  ...
  return (
    <form onSubmit={formActionSubmit} className="grid gap-4">
      ...
      <div>
        <Button className="sf-commerce-submit" type="submit" disabled={pending}>
