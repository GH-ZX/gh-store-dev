...
import { removeImportedProductAction } from "@/lib/admin-actions";
import type { RemoveImportedResult } from "@server/legacy/lib/services/admin-catalog.service";
...
export function ImportRemoveButton({
  ...
  function onClick(event: React.MouseEvent<HTMLButtonElement>): void {
    ...
    startTransition(async () => {
      ...
      // The admin action bridge revalidates the dashboard's loader data.
    });
  }
