...
import { sanitisePath } from "@server/lib/logging/outcome";
import { BatStoreError, classifyBatStoreStatus } from "@server/providers/batstore/errors";
import {
  orderSchema,
  productsSchema,
  toBatStoreOrder,
...
} from "@server/providers/batstore/schemas";
...
function baseUrl(): string {
  const override = runtimeVar("BATSTORE_API_BASE_URL")?.replace(/\/+$/, "");
